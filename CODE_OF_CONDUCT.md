...
This project analyses financial data. Two additional norms follow from that:

* **Do not use this project or its issue tracker to promote or solicit investments.** Fund
  recommendations, referral links, advisory services, and "which fund should I buy" threads are out
  of scope and will be closed.
* **Argue about numbers with evidence.** Disagreement over a formula, a convention, or a data point
  is welcome and useful — bring the source, the input, and the expected output. Confident assertion
  without evidence wastes reviewers' time, and in a financial context it is actively risky.
...
maintainer by contacting [@mchittineni](https://github.com/mchittineni) through GitHub — either via
a direct message or by opening a
[private security advisory](https://github.com/mchittineni/mutual-fund-analysis-tracker/security/advisories/new),
which is private to the maintainer and works for conduct reports as well.
